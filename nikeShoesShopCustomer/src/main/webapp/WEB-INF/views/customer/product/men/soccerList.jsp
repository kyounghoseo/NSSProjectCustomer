	...
	<div class="productContent">
		<section>
			<article class="men_list">
				<table>
					<c:choose>
						<c:when test="${not empty soccerList}">
							<c:forEach var="soccer" items="${soccerList }" varStatus="status">
								<tr>
									<td><a href="javascript:goDetail(${soccer.productNo})">${soccer.productName}</a></td>
									<td>${soccer.productPrice}</td>
								</tr>
							</c:forEach>
						</c:when>
						<c:otherwise>
