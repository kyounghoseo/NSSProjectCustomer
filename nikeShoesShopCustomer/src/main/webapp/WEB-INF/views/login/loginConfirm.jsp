...
<body>
	<c:choose>
			...
			<div id="wrap">
				<header class="main_header" id="main_header">
					...
					<div class="top_right_nav">
						...
						<a class="account_register" href="orderList.jsp"><b>${sessionScope.loginSession.customerName}님
								안녕하세요</b></a><a class="customercenter" href="#">고객센터</a> <a
							class="cart" href="#"><img src="cart.jpg" width="25px"
							; height="20px" ; alt="장바구니"></a>
					</div>
		...
		<table>
			<tbody>
				<tr>
					<td align="center"><input type="text" id="LoginCustomerID"
						name="LoginCustomerID" placeholder="아이디"></td>
				</tr>

				<tr>
					<td align="center"><input type="text" id="LoginCustomerPW"
						name="LoginCustomerPW" placeholder="비밀번호"></td>
				</tr>

				<tr>
					<td><input type="submit" value="로그인" id="loginInsert"></td>
				</tr>
				...
				<tr>
					<td><a href="#"><input type="button" value="회원가입">회원가입</a></td>
				</tr>
			</tbody>
		</table>
	</form> -->
			...
			<div class="footer">
				<div class="footer_top">
					<span> <a href="#">홈</a></span> <span> <a href="#">회사소개</a></span>
					<span> <a href="#">이용약관</a>
		...
		<c:otherwise>로그인 안됨</c:otherwise>
	</c:choose>
</body>
</html>